...
function Filter({
  ...
  return (
    <header className="flex flex-col w-full z-30">
      <div className="flex items-end justify-between w-full border-b border-zinc-300 dark:border-zinc-700 pb-2">
        <div className="flex items-center gap-1 lg:gap-1.5 text-zinc-600 dark:text-zinc-400">
          {tabs.map((tab, i) => (
            <Link
              ...
              key={i}
              className={`p-2 lg:px-3 py-0.5 hover:text-zinc-800 dark:hover:text-zinc-100 cursor-pointer rounded-sm ${
                tab === currentTab &&
        ...
        <div className="flex items-center gap-1 lg:gap-4">
          ...
          <button
            ...
            className="flex items-center gap-2 px-1.5 py-0.5 rounded-md text-sm bg-primary font-semibold text-zinc-100 cursor-pointer"
          >
      ...
      <div className="flex gap-2 items-center pt-2 text-sm whitespace-nowrap overflow-x-auto no-scrollbar">
